...
import static com.meng.stg.helpers.mbgparser.MBGUtils.*;
...
public final class GlobalEvents implements Serializable
{
	...
	public enum SleepModeType
	{
		...
		private static HashMap<Integer, SleepModeType> mappings;
		private static HashMap<Integer, SleepModeType> getMappings()
		{
			if (mappings == null)
			{
				synchronized (SleepModeType.class)
				{
					if (mappings == null)
					{
						mappings = new HashMap<Integer, SleepModeType>();
					}
				}
			}
			return mappings;
