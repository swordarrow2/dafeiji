...
public class stage1{
	...
	//	}
        switch(MainScreen.gameTime){
            ...
            case 20:
			  //i.update();
			    epc.setEnemyCenter(193,350).setHp(200).setEnemyType(EnemyType.Boss).setColor(EnemyColor.blue).setMoveMethods(new MoveMethodStraight(1,1,new Vector2(0,0.0001f)) ).createEnemy();
