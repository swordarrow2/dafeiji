...
public class EnemyItem extends BaseEnemyBullet{
    ...
    public static void create(Vector2 center,Form bf,Color bc,int ref,BaseMoveMethod... mm){
        ObjectPools.itemPool.obtain().init(center,bf,bc,ref,mm);
    }

    public void init(Vector2 center,Form bf,Color bc,int ref,BaseMoveMethod... mm){
        super.init();
        refCount=ref;
