...
public final class BulletEmitterConditions implements IConditionJudger<AbstractMBGComponent<BulletEmitter>> {
	public static final BulletEmitterConditions instance = new BulletEmitterConditions();
	public boolean judgeCondition(AbstractMBGComponent<BulletEmitter> bulletEmitter, Condition condition, int scaledTime) {
	...
	public boolean conditionOp(Condition.Expression.OpType opType, float p1, float p2) {
		switch (opType) {
		case Equals:
			return p1 == p2;
		case Less:
	...
	public boolean judgeExpr(AbstractMBGComponent<BulletEmitter> bulletEmitter, Expression expression, int scaledTime) {
