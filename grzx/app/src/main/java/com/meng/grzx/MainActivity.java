...
public class MainActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        listViewGroupReply.setOnItemClickListener(new OnItemClickListener() {
			  ...
			  public void onItemClick(AdapterView<?> adapterView,View view,final int i,long l){
				  ...
				  editText.setText(String.valueOf(configJavaBean.groupReply.get(i).groupNum));
	...
	/*
	 ...
	 loadConfigData(loadFromSDFile(new File(Environment.getExternalStorageDirectory()+"/grzx.json")));
	 }
