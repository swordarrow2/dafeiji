...
public class Yield {
    ...
    /**
     * @param runnable   Code to run when yield. The yield will return null.
     * @param repetition The repetition (Times Executed).
     */
    public void append(final Runnable runnable, int repetition) {
        append(new Callable<Object>() {
            @Override
    ...
    /**
     * @param callable   Code to run and return when yield.
     * @param repetition The repetition (Times Executed).
     */
     ...
     *
     * @return The object returned or null if the current one in the queue is a {@link Runnable}.
     */
    public Object yield() {
