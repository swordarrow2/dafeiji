...
public class fileTools {
    ...
    public static String openTextFile(String textFilePath) {
    ...
    public static String insertText(String fileText, String textToInsert) {
        int index = fileText.lastIndexOf("</paths>");
        StringBuilder sb = new StringBuilder(fileText);
        sb.insert(index, "\n <path dexFilePath=\"" + textToInsert + "\" />");
        return sb.toString();
    }
